...
var Outlet = React10.memo(function OutletImpl() {
  ...
  if (router.isShell)
    return (0, import_jsx_runtime11.jsx)(React10.Suspense, { fallback: pendingElement, children: (0, import_jsx_runtime11.jsx)(ShellInner, {}) });
  ...
  if (matchId === rootRouteId) {
    return (0, import_jsx_runtime11.jsx)(React10.Suspense, { fallback: pendingElement, children: nextMatch });
  }
  return nextMatch;
});
function ShellInner() {
...
function lazyRouteComponent(importer, exportName, ssr) {
  ...
  const lazyComp = function Lazy(props) {
    ...
    if ((ssr == null ? void 0 : ssr()) === false) {
      return (0, import_jsx_runtime12.jsx)(ClientOnly, { fallback: (0, import_jsx_runtime12.jsx)(Outlet, {}), children: React11.createElement(comp, props) });
    }
    return React11.createElement(comp, props);
  };
...
function Matches() {
  const router = useRouter();
  const pendingElement = router.options.defaultPendingComponent ? (0, import_jsx_runtime13.jsx)(router.options.defaultPendingComponent, {}) : null;
  const ResolvedSuspense = router.isServer || typeof document !== "undefined" && router.clientSsr ? SafeFragment : React13.Suspense;
  const inner = (0, import_jsx_runtime13.jsxs)(ResolvedSuspense, { fallback: pendingElement, children: [
    (0, import_jsx_runtime13.jsx)(Transitioner, {}),
    (0, import_jsx_runtime13.jsx)(MatchesInner, {})
  ] });
...
function MatchesInner() {
  ...
  return (0, import_jsx_runtime13.jsx)(matchContext.Provider, { value: matchId, children: (0, import_jsx_runtime13.jsx)(
    CatchBoundary,
    {
      getResetKey: () => resetKey,
      ...
      children: matchId ? (0, import_jsx_runtime13.jsx)(Match, { matchId }) : null
    }
  ) });
}
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-H334FTZB.js.map
