...
export function AccountEditForm({
  ...
  const [pendingValues, setPendingValues] = useState<AccountEditValues | null>(
    null,
  );
                  ...
                  <Field data-invalid={fieldState.invalid}>
                    ...
                    >
                      <PatternFormat
                        ...
                        format="+1 (###) ###-####"
                        aria-invalid={fieldState.invalid}
                        className="placeholder:text-muted-foreground dark:placeholder:text-muted-foreground w-full border-none bg-transparent p-0 text-base focus:border-none focus:ring-0 dark:bg-transparent sm:text-sm"
                      />
                    </div>
                    <FieldError errors={[fieldState.error]} />
                  </Field>
